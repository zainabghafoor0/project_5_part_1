...
#ifndef PRIORITY_QUEUE_STUDY_QUADRATICORACLE_HPP
#define PRIORITY_QUEUE_STUDY_QUADRATICORACLE_HPP
...
public:
    ...
    QuadraticOracle(bool (*)(const std::pair<int, int> &, const std::pair<int, int> &));
    explicit QuadraticOracle(const std::vector<std::pair<int, int>>& data,
...
#endif //PRIORITY_QUEUE_STUDY_QUADRATICORACLE_HPP